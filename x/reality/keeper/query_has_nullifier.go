...
func (k Keeper) HasNullifier(goCtx context.Context, req *types.QueryHasNullifierRequest) (*types.QueryHasNullifierResponse, error) {
	if req == nil {
	...
	has, err := k.Nullifiers.Has(ctx, req.Nullifier)
	if err != nil {
